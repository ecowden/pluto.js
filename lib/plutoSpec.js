...
test('when a constructor has zero parameters, module.get(name) returns the new Constructor()', function* (t) {
...
test('when a constructor has one parameter, module.get(name) returns the new Constructor() with the parameter injected', function* (t) {
...
test('when a constructor has two parameters, module.get(name) returns the new Constructor() with the parameters injected', function* (t) {
...
test('when a constructor has three parameters, module.get(name) returns the new Constructor() with the parameters injected', function* (t) {
...
test('Module.get(name) throws if the specified name is not mapped', function* (t) {
...
test('Module.eageryLoadAll executes all factory and constructor functions', function* (t) {
